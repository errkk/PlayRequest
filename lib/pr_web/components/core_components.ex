defmodule PRWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      {@rest}
    >
      <Heroicons.information_circle :if={@kind == :info} mini class="icon" />
      <Heroicons.exclamation_circle :if={@kind == :error} mini class="icon" />
      <div class="inner">
      ...
      <button
        ...
        aria-label={gettext("close")}
      >
        <Heroicons.x_mark solid class="close-icon" />
      </button>
    </div>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PRWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PRWeb.Gettext, "errors", msg, opts)
    end
  end
